...
r.in.gdal bedmap2_coverage.tif out=bedmap2_coverage title="Antarctic Bedmap Topography" --overwrite

r.timestamp map=bedmap2_coverage date='03 Dec 2020'
r.info bedmap2_coverage
# min = -7054  max = 3972
...
# visualize raster
g.list rast
g.region raster=bedmap2_coverage -p

# d.erase
d.mon wx0
r.colors --help
r.colors bedmap2_coverage col=etopo2
# plasma terrain rainbow etopo2
d.rast bedmap2_coverage
...
d.text text="Coverage" color='0:0:51' size=2.0 font=Arial
